    ...
    public partial class Mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanParticipants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanParticipants_AspNetUsers_ParticipantId",
                        column: x => x.ParticipantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlanParticipants_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanParticipants_ParticipantId",
                table: "PlanParticipants",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanParticipants_PlanId_ParticipantId",
                table: "PlanParticipants",
                columns: new[] { "PlanId", "ParticipantId" },
                unique: true);
